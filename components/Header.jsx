    ...
    <div className="px-4 py-3 lg:px-6">
      <div className="flex flex-col items-center justify-between md:flex-row">
        <ul className="flex flex-col order-2 w-full mt-0 text-sm font-medium border border-gray-200 rounded-lg bg-gray-50 md:flex-row md:order-1 md:bg-white dark:bg-gray-800 dark:border-gray-700 dark:md:bg-gray-900 md:rounded-none md:border-0">
          <li>
            <a href="#" className="block px-4 py-3 rounded-lg text-primary-600 hover:text-primary-700 dark:text-primary-500 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover-bg-gray-80 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700" aria-current="page">Home</a>
          </li>
          <li>
