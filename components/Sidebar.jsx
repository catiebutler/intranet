...
<button
  type="button"
  className="text-white bg-aptpblue border-b border-gray-200 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-aptpblue focus:outline-none dark:focus:ring-blue-800 center"
>
  <a href='/b85381431a1c49bd9e190fcbb3ec6736'>Expense Report</a>
</button>
<button
  type="button"
  className="text-white bg-aptpblue border-b border-gray-200 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-aptpblue focus:outline-none dark:focus:ring-blue-800 center"
