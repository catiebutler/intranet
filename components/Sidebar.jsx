...
const Sidebar = () => {
  return (
    <div className='col-span-1 row-span-2'>
      ...
      <h2 className='mt-4 mb-4 text-4xl font-extrabold dark:text-white'>Pathways</h2>
...
<button
  type="button"
  className="text-white bg-blue-700 border-b border-gray-200 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 center"
>
  Expense Report
</button>
<button
